...
public interface Robot {
	 ...
	 */
	DistanceSensor getLSensor();
	/**
	 * return RSensor
	 * @return DistanceSensor
	 */
	DistanceSensor getRSensor();
	/**
	 * return FSensor
	 * @return DistanceSensor
	 */
	DistanceSensor getFSensor();
	/**
	 * return BSensor
	 * @return DistanceSensor
	 */
	DistanceSensor getBSensor();
	void setBSensor(DistanceSensor b);
	void setFSensor(DistanceSensor f);
	void setLSensor(DistanceSensor l);
	void setRSensor(DistanceSensor r);
}
