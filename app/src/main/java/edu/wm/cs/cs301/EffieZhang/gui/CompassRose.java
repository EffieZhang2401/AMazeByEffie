...
import edu.wm.cs.cs301.EffieZhang.gui.MazePanel;
...
public class CompassRose {
    ...
    private static final int CIRCLE_SHADE = MazePanel.createNewColor(1.0f, 1.0f, 1.0f, 0.3f);
    ...
    //refactor all the graphics into MazePanel
    ...
    public void paintComponent(MazePanel p) {
        ...
        */
        ...
        //panel.setRenderingHint(MazePanel.P5RenderingHints.KEY_RENDERING, MazePanel.P5RenderingHints.VALUE_RENDER_QUALITY);
        //panel.setRenderingHint(MazePanel.P5RenderingHints.KEY_ANTIALIASING, MazePanel.P5RenderingHints.VALUE_ANTIALIAS_ON);
